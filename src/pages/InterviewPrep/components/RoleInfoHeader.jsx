...
const RoleInfoHeader = ({role,topicsToFocus,experience,questions,description,lastUpdated})=> {
  return (
    <div className='bg-white relative'>
      <div className="container ml-12 px-10 md:px-0">
        ...
        <div className="w-[40vw] md:w-[30w] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
